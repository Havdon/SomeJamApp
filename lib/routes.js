...
module.exports = function(app) {
  ...
  app.get('/api/interest/search/name/:string', api.searchForInterests);
  app.get('/api/interest/search/top/:location', api.getTopInterests);
  app.get('/api/interest/search/one/name/:string', api.searchForOneInterests);
  ...
  app.post('/api/user/validate', api.validateUser);
